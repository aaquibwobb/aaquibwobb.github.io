...
import { IconInvite } from "../ui/Icons";
...
export function InviteAndAssign() {
    ...
    return <Box>
        <Box padding={2} className={styles.header}>
            ...
            <Typography variant="h6" style={{ textTransform: 'uppercase' }}>Invite and Assign</Typography>
        </Box>
        <Box padding={4}>
            <Grid component="form" container spacing={1}>
                ...
                <Grid item xs={12}>
                    <Box padding={2} display="flex" flexDirection='row' alignItems="center" justifyContent="center">
                        <Box marginRight={1}>
                            <TextTransformNoneButton variant="outlined" color="default" size="large">Cancel</TextTransformNoneButton>
                        </Box>
                        <Box marginLeft={1}>
